class LinksController < ApplicationController
  ...
  def download_attachment
    send_file(Rails.root.join("archivos", "#{@link_attachment.attachment_id}","original",
      @link_attachment.attachment.archivo_file_name))
  ...
  def validate_link
    if @link.nil? || @link.is_invalid?
      redirect_to invalid_path, notice:"El link de descarga no es valido o ah expirado"
    end
  end
end